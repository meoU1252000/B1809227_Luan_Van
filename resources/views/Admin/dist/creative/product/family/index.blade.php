                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Trang Quản Lý Nhóm Sản Phẩm</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                        ...
                                        <div class="text-lg-end">
                                            <a href="{{ route('family.create') }}"
                                                class="btn btn-danger waves-effect waves-light mb-2 me-2"><i
                                                    class="mdi mdi-tag me-1"></i>Thêm Nhóm Sản Phẩm Mới</a>
                                    ...
                                    <table class="table table-centered table-nowrap mb-0" style="table-layout:fixed;">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th style="width: 125px;">ID Nhóm</th>
                                        ...
                                        <tbody>
                                            @foreach ($product_families as $product_family)
                                                <tr>
                                                    ...
                                                    <td><a href="" class="text-body fw-bold">{{ $product_family->id }}</a>
                                                    </td>
                                                    <td
                                                    ...
                                                    <td>
                                                        <div style="display:flex">
                                                            ...
                                                            <a href="{{ route('family.edit', $product_family->id) }}"
                                                                class="action-icon">
                                                                <i class="mdi mdi-pencil-outline me-1"></i></a>
                                                            <form action="{{ route('family.delete', $product_family->id) }}"

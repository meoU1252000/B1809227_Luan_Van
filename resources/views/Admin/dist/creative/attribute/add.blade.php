                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="category-id" class="form-label">Chọn Danh Mục Cần Thêm Thuộc Tính<span
                                    ...
                                    <div class="mb-3">
                                        <label for="volume" class="form-label">Số Thuộc Tính Cần Thêm<span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="card_more" style="margin-top: 15px">
                                    </div>
...
@section('footer')
    ...
    <script>
        Validator({
            ...
            rules: [
                Validator.isRequired('#category-id'),
        ...
        const showAttributeData = () => {
            const volumeAttribute = document.getElementById('volume').value;
            event.preventDefault();
            var data = '';
            if (volumeAttribute > 0) {
                for (let i = 0; i < volumeAttribute; i++) {
                    data += '<div class="mb-3"><label for="category-name" class="form-label">Thuộc tính' + ' ' + [i +
                            1
                        ] +
                        '<span class="text-danger">*</span></label>' +
                        '<input type="text" name="attribute_name[]" class="form-control test" placeholder="e.g : CPU">' +
                        '<span class="form-group__message"></span>' +
                        '</div>'

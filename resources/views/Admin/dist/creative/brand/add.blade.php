    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <form action="{{route('brand.store')}}" method="POST" enctype="multipart/form-data" id = "validator" >
                        @csrf
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="brand-description" class="form-label">Miêu Tả Thương Hiệu<span
                                                class="text-danger">*</span></label>
                                        <textarea id="brand-description" style="height: 150px;width:100%" name="brand_description"></textarea>
                                        <span class="form-group__message"></span>
                                        <!-- end Snow-editor-->
                                    </div>
